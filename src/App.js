...
let myContent = {
  ...
  rightContent: {
    ...
    button: {
      buttonText: "Click it!",
      buttonFunction: () => alert('Hello there!')
    }
  }
}
...
const App = () => (
  <div className="App">
    <Header title={myContent.headerTitle} className="header" />
    <div className="content-wrapper">
      <Picture
        imgUrl={myContent.leftContent.imgUrl}
        imgAlt={myContent.leftContent.imgAlt}
      />
      <ParagraphAndButton content={myContent.rightContent} />
    </div>
  </div>
);
